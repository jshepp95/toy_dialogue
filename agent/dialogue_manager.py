...
def greet(state: AudienceBuilderState) -> AudienceBuilderState:
    ...
    prompt = ChatPromptTemplate.from_messages([
        """You are an audience building assistant for Pollen.
...
def identify_product(state: AudienceBuilderState) -> AudienceBuilderState:
    ...
    print(f"\n\n Product Identification Result: {result}")
    ...
    if not result.product_name:
        ...
        print(f"\n\nFound a Product Name: {result.product_name}\n\n")

        # Found a Product -> confirm and then move to lookup step
        ...
        print(f"\n\nConfirmation Response: {confirmation_response.content}")
...
#             You MUST Respond warmly to the user confirming the Product Name.

#             Once done, summarise the product variants that have been found, specifying the unique Buyer Categories and Product Categories.
